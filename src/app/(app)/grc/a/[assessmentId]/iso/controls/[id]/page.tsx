    ...
    <div className="grid gap-6 lg:grid-cols-12">
      <div className="lg:col-span-7">
        ...
        <div className="panel mt-6 p-5">
          <ControlDetailForm assessmentId={assessment.id} controlId={id} status={row?.status ?? 'not_started'} justification={row?.justification ?? ''} owner={row?.owner ?? ''} evidenceUrls={row?.evidenceUrls ?? []} lang={lang} />
        </div>
      </div>
